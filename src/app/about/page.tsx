    ...
    <article className="max-w-3xl text-neutral-800 dark:text-neutral-200">
      ...
      <section className="mt-8">
        ...
        <p className="mt-2 leading-relaxed">
          ...
          パッケージが組み立てられます。このカードの選定・組み立てという工程に、
          人間の判断や外部の AI モデルによる推論は一切介在しません。すべての計算は
          ブラウザ内で完結する決定論的なロジックであり、同じ入力からは常に同じ
          出力が得られます。
        </p>
        <p className="mt-2 leading-relaxed">
      ...
      <section className="mt-8">
        ...
        <p className="mt-2 leading-relaxed">
          ...
          文面とスコアはあらかじめ人が作成したものですが、そこからの採否の決定は、
          実在の人物・団体を想起させないよう機械的なルールに基づいています。本アプリの
          内容を、現実の政策判断の根拠として用いないでください。
        </p>
      </section>
